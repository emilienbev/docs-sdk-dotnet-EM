...
Fix an issue regarding passing an X509CertificateFactory in ClusterOptions.
* https://issues.couchbase.com/browse/NCBC-3768[NCBC-3768]:
Align Boolean search API to RFC.
...
Update Release version tag in SDK Directory.Build.Props.
* https://issues.couchbase.com/browse/NCBC-3794[NCBC-3794]:
Remove infinite loop in ConfigPushHandler, causing high CPU usage.

==== New Feature

* https://issues.couchbase.com/browse/NCBC-3788[NCBC-3788]:
Support for base64 encoded vector types.

==== Improvements

* https://issues.couchbase.com/browse/NCBC-3771[NCBC-3771]:
Refactor RetryOrcestrator for K/V operations to be clearer.
...
Update local build version to 3.6.0.
* https://issues.couchbase.com/browse/NCBC-3797[NCBC-3797]:
Update VectorSearch's InterfaceStability to Committed.
